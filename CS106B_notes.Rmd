...
## LECTURE 6: unordered DS (sets and maps)
...
#include <iostream>     ## pound include
#include "console.h"    ## Like import in Py
using namespace std;
...
- Program starts at main function and executes its statements in sequence
- main return value at program end:
  + 0: indicates successful completion.
  + non-zero value: error code i.e. 404. Beyond class scope.
- libraries
  + #include <libraryname> // standard C++ library
  + #include "libraryname.h" // local project library

### C++ variables and types
- announce variable type to the compiler first time you introduce variable
- can't change data type (i.e. const in js)
...
## CS 106A Course information
### Instructors
Instructor: Nick Parlante, nick.parlante@cs.stanford.edu <br>
Head TA: Juliette Woodrow, jwoodrow@stanford.edu <br>

### Office hours
- OH w/ Nick: 
  + 3-4 on Mondays and Wednesdays (next to Dunrad 311)
  + 11:30-2:00
- OH w/ Juliette: 
  + 4-? on Tuesdays
- LaIR on Zoom
...
### Grading
- HW 45%
  + due on Tuesdays/Wednesdays @ 11:55 pm
  + 2% on-time bonus for on-time HW submission
  + 48 hr grace period - no grade drop
- Section 5%
- Exams 50%
- Midterm 7 pm on Monday, week 6

### Honor code
- No sharing/viewing other students' code
- Internet help: scope up to methods allowed
- Mention collaborators at top of HW. Honor code checked in December
...
- *=* assigns value
- *==* Compares two values
- *!=* Not equal comparison (returns true if not equal)
- *not boolean* inverts boolean
